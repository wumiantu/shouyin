         ...
         <table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;"> 
          ...
          <tbody class="js-list-body-region" id="table-list-body">
           ...
           <tr class="widget-list-item">
			...
			<td class="footable-visible footable-last-column"><button class="btn btn-sm btn-primary btn-primary-ewm" data-cdid="<?php echo $ovv['id'];?>"><strong>查看二维码</strong></button>  <a class="btn btn-sm btn-info"  href="?m=User&c=wxCoupon&a=cardetail&id=<?php echo $ovv['id'];?>" style="vertical-align:top;"> 详 情 </a>  <button onclick="deltheOrder(this,<?php echo $ovv['id'];?>);" class="btn btn-sm btn-danger"><strong> 删 除 </strong></button></td>
           </tr>
		   <?php }}else{?>
