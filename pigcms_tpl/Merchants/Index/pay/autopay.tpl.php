    ...
    <div class="cashier-info-container center">
	 ...
	 <div class="block-wrapper-form payer-form"> 
      <div class="block-form-item"> 
       ...
       <input type="text" class="item-input" id="js-payer-price"  name="goods_price" value="<?php if(!empty($orderInfo)) echo $orderInfo['goods_price'];?>" placeholder="输入你要付的金额（必填）"/>
      </div> 
     </div> 
	 ...
	 <div class="block-wrapper-form payer-form"> 
      <div class="block-form-item"> 
       ...
       <input type="text" class="item-input" id="js-payer-name"  name="goods_name" value="<?php if(!empty($orderInfo)) echo $orderInfo['goods_name'];?>" placeholder="输入收款理由"/> 
      </div> 
     </div>
