...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if(defined('WxPay_SUBAPPID')){ $inputObj->SetSubAppid(WxPay_SUBAPPID); } //子公众账号ID
		if(defined('WxPay_SUBMCHID')){ $inputObj->SetSubMch_id(WxPay_SUBMCHID); } //子商户号
	...
	{	
		//$rootca='/upload/pem/1/20150814/rootca.pem';
		//if(defined('ABS_UPLOAD_PATH')) $rootca=ABS_UPLOAD_PATH.$rootca;
		$ch = curl_init();
		//设置超时
