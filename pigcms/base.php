...
class bpBase {
	 ...
	 * @param string $classname 类名
	 */
	public static function loadOrg($classname){
		if (file_exists(RL_PIGCMS_CORE_PATH.'libs'.DIRECTORY_SEPARATOR.'org'.DIRECTORY_SEPARATOR.$classname.'.class.php')) {
			include RL_PIGCMS_CORE_PATH.'libs'.DIRECTORY_SEPARATOR.'org'.DIRECTORY_SEPARATOR.$classname.'.class.php';
		}
	}
	/**
	 * 加载插件函数库
